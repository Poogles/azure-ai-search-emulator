...
- Semantic search, suggest, scoring profiles — unless the operations matrix requires them. (Vector search was descoped here and is now covered by Phase 2.1, `docs/implementation/phase_2_1_vector_indexing.md`.)
